...
def main(_):
    ...
    for phase in phases:
        ...
        for stage, budget in enumerate(task['budgets']):
            ...
            ckpt_id = ckpt_id * 300 - 1

            ckpt_path = '/home/ubuntu/coral/object-detection-pipeline/checkpoints_teacher/new_pl_4.1_fasterrcnn/version_new_pl_4.1/epoch={}.ckpt'.format(ckpt_id)
