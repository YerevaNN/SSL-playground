...
def load_api_instances(dirname: str, label_root: str, image_file: str, class_names: list, has_box: bool):
    """
    ...
    for fileid in fileids:
        ...
        anno_file = os.path.join(label_root, fileid + ".txt")
        ...
        if has_box:
            with open(anno_file) as annotations:
                for anno in annotations:
                    cls, xmin, ymin, xmax, ymax = anno.split(' ')
...
def register_api_dataset(name, dirname, label_root, image_file, class_names, has_box):
    DatasetCatalog.register(name, lambda: load_api_instances(dirname, label_root, image_file, class_names, has_box))
